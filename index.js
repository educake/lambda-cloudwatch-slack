...
var handleCodeDeploy = function(event, context) {
  ...
  try {
    ...
    var status = message.detail.state;
    var snsMessage = message["detail-type"] + ": " + status;
    if(status === "SUCCESS"){
      color = "good";
    } else if(status === "FAILURE"){
      color = "danger";
    }
    fields.push({ "title": "Message", "value": snsMessage, "short": false });
    fields.push({ "title": "Deployment Group", "value": message.detail.deploymentGroup, "short": true });
    fields.push({ "title": "Application", "value": message.detail.application, "short": true });
    fields.push({
      "title": "Status Link",
      "value": "https://console.aws.amazon.com/codedeploy/home?region=" + message.region + "#/deployments/" + message.detail.deploymentId,
      "short": false
    });
  }
  catch(e) {
    ...
    fields.push({ "title": "Message", "value": "Unknown message", "short": false });
